...
import model.yolov3_quant_origin
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_weights", type=str, default="./weights/416/yolov3_voc_O_416.pth",
    ...
    quantized_model = model.yolov3_quant_h.YOLOv3(args.image_size, num_classes).to(device)
